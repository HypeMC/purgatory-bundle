        ...
        $rootNode
            ...
            ->children()
                ...
                ->arrayNode('route_ignore_patterns')
                    ...
                    ->defaultValue([])
                ->end()
                ->booleanNode('auto_detect_response_groups')
                    ->info('Use the serialization groups of the "#[Serialize]" attribute as the target of "#[PurgeOn]" attributes without an explicit target.')
                    ->defaultFalse()
                ->end()
