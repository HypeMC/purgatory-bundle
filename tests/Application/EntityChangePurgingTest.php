...
final class EntityChangePurgingTest extends AbstractKernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        self::assertSame(self::EXPECTED_STATE[$this->name()], (new EntityChangePurgeSwitcher(false))->isEnabled());

        self::initializeApplication(['test_case' => 'EntityChangeListener', 'config' => 'entity_change_purging_disabled.yaml']);
